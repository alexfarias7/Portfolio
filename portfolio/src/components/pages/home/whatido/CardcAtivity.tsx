...
const CardcAtivity = ({
  ...
  return (
    <div className="relative group">
      ...
      <div className="border-solid border-[2px] rounded-sm text-blue0 border-blue9 flex flex-col gap-[8px] items-center justify-center py-[40px]  px-[8px] font-tinos font-semibold text-2xl shadowCard bg-blue6  group-hover:border-purple5 transition duration-500 ease-in-out">
        <CmsIcon icon={iconSvg} />
        <div className="flex flex-wrap justify-center gap-x-[8px]">
          <h5>{activity}</h5>
          <h5>{activityComplement}</h5>
        </div>
        <p className="text-center font-popins  text-blue3 group-hover:text-purple5  transition duration-500 ease-in-out">
          {description}
        </p>
      </div>
    </div>
