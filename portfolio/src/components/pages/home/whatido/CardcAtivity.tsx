...
const CardcAtivity = ({
	...
	return (
		<div className="border-solid border-[2px] rounded-[2px] text-blue0 border-blue9 flex flex-col gap-[8px] items-center justify-center py-[60px]  px-[20px] font-montserrat font-semibold text-[22px] shadowCard bg-blue6 group hover:border-purple5 hover:text-purple5 transition duration-500 ease-in-out ">
			{icon}
